...
public class OracleTeamDAO implements TeamDAO {
	...
	private final static String SQL_SELECT_TEAMS_FOR_USER = "select \"TEAM\".* from \"TEAM\" join \"TEAM_INTERACT\" on \"team_id\" = \"team\" join \"TEAM_INTERACT_TYPE\" on \"type\" = \"type_id\" join \"USER\" on \"user_id\" = \"user\" where \"USER\".\"user_id\" = ? and \"type_name\" = 'Join' order by \"time\" desc fetch first 1 ROWS only";
